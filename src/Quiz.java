...
public class Quiz extends JFrame implements ActionListener{
    ...
    String name;
        ...
        answers[9][1] = "Bytecode is executed by JVM";
            ...
            op1.setFont(new Font("Dilog",Font.PLAIN,20));
            ...
            op2.setFont(new Font("Dilog",Font.PLAIN,20));
            ...
            op3.setFont(new Font("Dilog",Font.PLAIN,20));
            ...
            op4.setFont(new Font("Dilog",Font.PLAIN,20));
            ...
            next.setFont(new Font("Thoma",Font.PLAIN,22));
            ...
            lifeline.setFont(new Font("Thoma",Font.PLAIN,22));
            ...
            submit.setFont(new Font("Thoma",Font.PLAIN,22));
